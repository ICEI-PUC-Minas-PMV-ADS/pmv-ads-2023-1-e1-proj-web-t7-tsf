...
|Critérios de Êxito:|1) o campo Abordagem deve receber, no máximo, 400 caracteres;  <br/> 2) O campo CRP deve receber somente números e, no máximo, 10 carcteres; <br/> 3) O campo Nome deve receber, no máximo, 23 caracteres; <br/> 4)O campo Endereço deve receber, no máximo, 26 caracteres; <br/> 5)O campo Cidade deve receber, no máximo, 58 caracteres; <br/> 6) O campo Estado deve receber, no máximo, 02 caracteres; <br/>  7) O campo Instagram deve receber, no máximo, 20 caracteres; <br/> 8) O campo Número deve receber somente número, no máximo, 10 caracteres; <br/> 9) O campo CEP deve receber somente número, no máximo, 11 caracteres; <br/> 9) O campo Telefone deve receber somente número e, no máximo, 13 caracteres; <br/> 10) O campo e-mail deve receber dados no formato e-mail e deve ser requerido para envio do formulário e ter, no máximo, 50 caracteres; <br/> 11) O campo Senha pode receber, no máximo, 30 carcteres e esses devem ter o valor digitado ocultados e requerido para envio do formulário; <br/> 12) O campo Confirmar Senha pode receber, no máximo, 30 carcteres e esses devem ter o valor digitado ocultados e requerido para envio do formulário, além de verificar se o valor digitado é igual ao valor digitado no campo senha.| 
...
|Critérios de Êxito:|1) O campo Nome deve receber, no máximo, 23 caracteres; <br/> 2) O campo País de Origem deve receber, no máximo, 25 caracteres; <br/> 3) O  campo País Atual deve receber, no máximo, 25 caracteres; <br/> 4) O campo Número de Telefone deve receber somente número e, no máximo, 13 caracteres; <br/> 5)O campo e-mail deve receber dados no formato e-mail e deve ser requerido para envio do formulário e ter, no máximo, 50 caracteres; <br/> 6) O campo Senha pode receber, no máximo, 30 carcteres e esses devem ter o valor digitado ocultados e requerido para envio do formulário; <br/> 7) O campo Confirmar Senha pode receber, no máximo, 30 carcteres e esses devem ter o valor digitado ocultados e requerido para envio do formulário, além de verificar se o valor digitado é igual ao valor digitado no campo senha.|
